...
class TBFData:
    ...
    ##############################
    def fmsuxux(self):
        return self.fuxux() - self.fux()**2 /self.f()

    def fmsuyuy(self):
        return self.fuyuy() - self.fuy()**2 /self.f()

    def fmsuzuz(self):
        return self.fuzuz() - self.fuz()**2 /self.f()
    
    def fmsuxuy(self):
        return self.fuxuy() - self.fux()*self.fuy() /self.f()

    def fmsuxuz(self):
        return self.fuxuz() - self.fux()*self.fuz() /self.f()

    def fmsuyuz(self):
        return self.fuyuz() - self.fuy()*self.fuz() /self.f()
    ...
    def Uw(self):
        ...
        return u[0]-(u[1]-u[0])/(y[1]-y[0])*y[0]
